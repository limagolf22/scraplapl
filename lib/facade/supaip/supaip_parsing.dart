...
List<SupAip> parseAllSupAip(List<Element> elements, String fir) {
  return elements.map((e) => parseSupAip(e, fir)).toList();
}

SupAip parseSupAip(Element trElement, String fir) {
